...
class No_Exit(MDP):
    ...
    def __init__(self, field_size, ball_speed = 2, random_start = True):
...
# Tabular Q-learn
test_learn_play(d=9, iters=10000000, tabular=True, batch=False, draw = True)
# Tabular Batch Q-learn
# test_learn_play(d=6, iters=300, tabular=True, batch=True, draw=False) # Check: why do we want fewer iterations here?
# NN Q-learn
# test_learn_play(d=4, iters=10000 , tabular=False, batch=False, draw=False)
# NN Batch Q-learn (Fitted Q-learn)
# test_learn_play(d=4, iters=10   , tabular=False, batch=True, draw=False)
